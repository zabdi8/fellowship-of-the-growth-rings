...
e13a_bet_n_02_u03$row_names <- rownames(e13a_bet_n_02_u03)
...
write.rwl(e13a_bet_n_02_u, "data/ring_data/aligned/e13a/e13a.bet.n/e13a_bet_n_02/e13a_bet_n_02_u.rwl", 
          format = "compact",
