...
e13a_bet_n_01_t01 <- e13a_bet_n_01_t01[-1, ]
e13a_bet_n_01_t02 <- e13a_bet_n_01_t02[-1, ]
e13a_bet_n_01_t03 <- e13a_bet_n_01_t03[-1, ]
...
e13a_bet_n_01_t01$row_names <- rownames(e13a_bet_n_01_t01)
e13a_bet_n_01_t02$row_names <- rownames(e13a_bet_n_01_t02)
e13a_bet_n_01_t03$row_names <- rownames(e13a_bet_n_01_t03)
...
rownames(e13a_bet_n_01_t) <- e13a_bet_n_01_t[[common_column]]
e13a_bet_n_01_t[[common_column]] <- NULL

View(e13a_bet_n_01_t)
...
#Data Analysis####
##Statistics####
e13a_bet_n_01_t_stats <- rwl.stats(e13a_bet_n_01_t) #summary and stats
print(e13a_bet_n_01_t_stats)

e13a_bet_n_01_t_ms <- sens2(e13a_bet_n_01_t) #calculates the mean sensitivity
print(e13a_bet_n_01_t_ms)

e13a_bet_n_01_t_report <- rwl.report(e13a_bet_n_01_t)  #report on rwl
print(e13a_bet_n_01_t_report)

##Cross-dating and alignment####

#shorten the name
e13a_bet_n_01_t_short <- e13a_bet_n_01_t
colnames(e13a_bet_n_01_t)
new_colnames <- sub("^E13ABetn01", "", colnames(e13a_bet_n_01_t_short))

# Assign the new column names to the data frame
colnames(e13a_bet_n_01_t_short) <- new_colnames

head(e13a_bet_n_01_t_short)
colnames(e13a_bet_n_01_t_short)

#graphs
seg.plot(e13a_bet_n_01_t_short) #creates a segment plot
spag.plot(e13a_bet_n_01_t_short, zfac=0.009,) #creates a spaghetti plot
title(main = "e13abetn01t", adj = 0.48, line = 5.5, font.main = 2, cex.main = 1.2) #add title

##Analysis####

e13a_bet_n_01_t_inter <- interseries.cor(e13a_bet_n_01_t, n = NULL, prewhiten = FALSE, biweight = FALSE, method = "spearman")        #correlation between series and master
print(e13a_bet_n_01_t_inter)
