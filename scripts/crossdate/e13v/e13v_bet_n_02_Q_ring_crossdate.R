...
e13v_bet_n_02_q02 <- csv2rwl("data/ring_data/raw/e13v/e13v.bet.n/e13v_bet_n_02/q/E13V.Bet.n.02.q02.csv")
...
e13v_bet_n_02_q05 <- csv2rwl("data/ring_data/raw/e13v/e13v.bet.n/e13v_bet_n_02/q/E13V.Bet.n.02.q05.csv")
...
e13v_bet_n_02_q02 <- e13v_bet_n_02_q02[-1, ]
e13v_bet_n_02_q03 <- e13v_bet_n_02_q03[-1, ]
e13v_bet_n_02_q04 <- e13v_bet_n_02_q04[-1, ]
e13v_bet_n_02_q05 <- e13v_bet_n_02_q05[-1, ]
...
e13v_bet_n_02_q02$row_names <- rownames(e13v_bet_n_02_q02)
e13v_bet_n_02_q03$row_names <- rownames(e13v_bet_n_02_q03)
e13v_bet_n_02_q04$row_names <- rownames(e13v_bet_n_02_q04)
e13v_bet_n_02_q05$row_names <- rownames(e13v_bet_n_02_q05)
...
# corr.rwl.seg(rwl = e13v_bet_n_02_q_short, seg.length = 2, bin.floor = 0, n = NULL, prewhiten = FALSE, pcrit = 0.05, 
