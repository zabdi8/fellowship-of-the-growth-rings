...
e13v_bet_n_02_u02 <- csv2rwl("data/ring_data/raw/e13v/e13v.bet.n/e13v_bet_n_02/u/E13V.Bet.n.02.u02.csv")
e13v_bet_n_02_u03 <- csv2rwl("data/ring_data/raw/e13v/e13v.bet.n/e13v_bet_n_02/u/E13V.Bet.n.02.u03.csv")
e13v_bet_n_02_u04 <- csv2rwl("data/ring_data/raw/e13v/e13v.bet.n/e13v_bet_n_02/u/E13V.Bet.n.02.u04.csv")
e13v_bet_n_02_u05 <- csv2rwl("data/ring_data/raw/e13v/e13v.bet.n/e13v_bet_n_02/u/E13V.Bet.n.02.u05.csv")
e13v_bet_n_02_u06 <- csv2rwl("data/ring_data/raw/e13v/e13v.bet.n/e13v_bet_n_02/u/E13V.Bet.n.02.u06.csv")
...
e13v_bet_n_02_u03 <- e13v_bet_n_02_u03[-1, ]
e13v_bet_n_02_u04 <- e13v_bet_n_02_u04[-1, ]
e13v_bet_n_02_u05 <- e13v_bet_n_02_u05[-1, ]
...
e13v_bet_n_02_u02$row_names <- rownames(e13v_bet_n_02_u02)
e13v_bet_n_02_u03$row_names <- rownames(e13v_bet_n_02_u03)
e13v_bet_n_02_u04$row_names <- rownames(e13v_bet_n_02_u04)
e13v_bet_n_02_u05$row_names <- rownames(e13v_bet_n_02_u05)
...
spag.plot(e13v_bet_n_02_u_short, zfac=0.01,) #creates a spaghetti plot
title(main = "e13vBetn02t", adj = 0.48, line = 5.2, font.main = 2, cex.main = 1.2) #add title
...
# corr.rwl.seg(rwl = e13v_bet_n_02_u_short, seg.length = 4, bin.floor = 0, n = NULL, prewhiten = FALSE, pcrit = 0.05, biweight = FALSE, method = c("spearman"), make.plot = TRUE, label.cex = 1, floor.plus1 = FALSE, master = NULL)
