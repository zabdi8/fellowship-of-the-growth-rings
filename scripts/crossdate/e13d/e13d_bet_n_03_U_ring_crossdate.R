...
e13d_bet_n_03_u04 <- e13d_bet_n_03_u04[-1, ]
...
e13d_bet_n_03_u04$row_names <- rownames(e13d_bet_n_03_u04)
...
e13d_bet_n_03_u[[common_column]] <- NULL

View(e13d_bet_n_03_u)

#export rwl

write.rwl(e13d_bet_n_03_u, "data/ring_data/aligned/e13d/e13d.bet.n/e13d_bet_n_03/e13d_bet_n_03_u.rwl", 
          format = "compact",
...
#Data Analysis####
##Statistics####
e13d_bet_n_03_u_stats <- rwl.stats(e13d_bet_n_03_u) #summary and stats
print(e13d_bet_n_03_u_stats)

e13d_bet_n_03_u_ms <- sens2(e13d_bet_n_03_u) #calculates the mean sensitivity
print(e13d_bet_n_03_u_ms)

e13d_bet_n_03_u_report <- rwl.report(e13d_bet_n_03_u)  #report on rwl
print(e13d_bet_n_03_u_report)

##Cross-dating and alignment####

#shorten the name
e13d_bet_n_03_u_short <- e13d_bet_n_03_u
colnames(e13d_bet_n_03_u)
new_colnames <- sub("^E13DBetn03", "", colnames(e13d_bet_n_03_u_short))

# Assign the new column names to the data frame
colnames(e13d_bet_n_03_u_short) <- new_colnames

head(e13d_bet_n_03_u_short)
colnames(e13d_bet_n_03_u_short)

#graphs
seg.plot(e13d_bet_n_03_u_short) #creates a segment plot
title(main = "E13DBetn03u", adj = 0.48, line = 5.2, font.main = 2, cex.main = 1.2) #add title
spag.plot(e13d_bet_n_03_u_short, zfac=0.005,) #creates a spaghetti plot
title(main = "E13DBetn03u", adj = 0.48, line = 5.2, font.main = 2, cex.main = 1.2) #add title

##Analysis####

e13d_bet_n_03_u_inter <- interseries.cor(e13d_bet_n_03_u_short, n = NULL, prewhiten = FALSE, biweight = FALSE, method = "spearman")        #correlation between series and master
print(e13d_bet_n_03_u_inter)

###General correlation####

corr.rwl.seg(rwl = e13d_bet_n_03_u_short, seg.length = 4, bin.floor = 0, n = NULL, prewhiten = FALSE, pcrit = 0.05, 
